...
A comprehensive dbt (data build tool) project template for transforming HubSpot CRM data into actionable analytics models. This template helps organizations build a unified view of their customer journey and business performance metrics across all departments.
